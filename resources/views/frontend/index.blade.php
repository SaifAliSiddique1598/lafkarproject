            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="w-[80px] h-[80px] bg-primary rounded-full">
                        <img src="{{url('/')}}/frontend_assets/images/product-1.jpg" class="rounded-full p-2" alt="Product">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="w-[80px] h-[80px] bg-primary rounded-full">
                        <img src="{{url('/')}}/frontend_assets/images/product-2.jpg" class="rounded-full p-2" alt="Product">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="w-[80px] h-[80px] bg-primary rounded-full">
                        <img src="{{url('/')}}/frontend_assets/images/product-3.jpg" class="rounded-full p-2" alt="Product">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="w-[80px] h-[80px] bg-primary rounded-full">
                        <img src="{{url('/')}}/frontend_assets/images/product-4.jpg" class="rounded-full p-2" alt="Product">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="w-[80px] h-[80px] bg-primary rounded-full">
            ...
            <div class="grid grid-cols-12">
               ...
               <div class="col-span-9">
                    <div class="h-[55px] rounded-r-lg bg-bgGray flex justify-center items-center">
                            <marquee behavior="" direction="left">{{ $ticker->message }}</marquee>
                    </div>
                </div>
            </div>
        </div>
                ...
                @foreach($banners as $banner)
                    <div class="swiper-slide">
                        <div class="w-full h-[260px]">
                            <img src="{{ asset($banner->image ? 'images/banners/' . $banner->image : 'assets/images/no-image.png') }}" class="w-full h-full object-cover rounded-lg" alt="Banner">
                        </div>
                    </div>
                @endforeach
            </div>
        ...
        <div class="grid grid-cols-12 mb-4  bg-bgGray p-2 rounded-lg">
            <div class="col-span-4">
                <div class="w-full h-[150px]">
                    <img src="{{ asset($faq->image ? 'images/faqs/' . $faq->image : 'assets/images/no-image.png') }}" class="w-full h-full object-cover rounded-lg" alt="Banner">
                </div>
            </div>
            <div class="col-span-8">
                <div class="flex flex-col justify-between h-full ps-4">
                    <div class="">
                        <h2 class="text-lg font-bold text-primary mb-2 leading-tight">{{ $faq->title }}</h2>
