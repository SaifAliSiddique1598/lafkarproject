<footer>
    <div class="flex items-center justify-between bg-bgGray py-4 px-3 fixed bottom-0 z-20 w-full max-w-[786px] ">
        <!-- Home Tab -->
        <div class="bottomBar {{ (request()->is('frontend')) ? 'active' : '' }}">
        ...
        <!-- Portfolio Tab -->
        <div class="bottomBar {{ (request()->is('frontend/portfolio')) ? 'active' : '' }}">
            <a href="{{route('frontend.page', 'portfolio')}}">
        ...
        <!-- Trade Tab -->
        <div class="bottomBar {{ (request()->is('frontend/trade')) ? 'active' : '' }}">
            <a href="{{route('frontend.page', 'trade')}}">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="36" height="36">
        ...
        <!-- Profile Tab -->
        <div class="bottomBar {{ (request()->is('frontend/profile')) ? 'active' : '' }}">
            <a href="{{route('frontend.page', 'profile')}}">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="36" height="36">
