                    ...
                    <div class="table-responsive table-card mb-3">
                        <table class="table align-middle table-nowrap mb-0" id="customerTable">
                            ...
                            <tr class="user-row" data-status="{{ $user->status }}">
                                ...
                                <td class="">{{ $user->trade_id }}</td>
                                <td class="">{{ $user->trade_count }}</td>
                                <td class="">{{ $user->balance_amount }}</td>
                                <td class="">{{ $user->created_at->format('d-m-Y') }}</td>
                                <td class="">{{ $user->total_amount }}</td>
                                <td>
            ...
            <div class="modal fade" id="showModal{{$user->id}}" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-0">
                           ...
                           <form action="{{ route('admin.profile-management.update', $user->id)}}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-12">
                                            <div>
                                                ...
                                                <input type="text" id="customername-field" class="form-control" placeholder="Enter name" value="{{ $user->name }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div>
                                                <label for="designation-field" class="form-label">Designation</label>
                                                <input type="text" id="designation-field" class="form-control" placeholder="Enter Designation" value="{{ $user->designation }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div>
                                                <label for="designation-field" class="form-label">Trade ID</label>
                                                <input type="text" id="company_name-field" class="form-control" placeholder="Enter Trade ID" value="{{ $user->trade_id }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div>
                                                <label for="email_id-field" class="form-label">Trades</label>
                                                <input type="text" id="email_id-field" class="form-control" placeholder="Enter Trades" value="{{ $user->trade_count }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div>
                                                <label for="wallet_balance-field" class="form-label">Wallet Balance</label>
                                                <input type="text" id="phone-field" class="form-control" placeholder="Enter Wallet Balance" value="{{ $user->balance_amount }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div>
                                                <label for="create_date-field" class="form-label">Create Date</label>
                                                <input type="text" id="lead_score-field" class="form-control" placeholder="Enter Create Date" value="{{ $user->created_at->format('d-m-Y') }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div>
                                                <label for="revenue-field" class="form-label">Revenue</label>
                                                <input type="text" id="lead_score-field" class="form-control" placeholder="Enter Revenue" value="{{ $user->total_amount }}">
                                            </div>
                                        </div>
