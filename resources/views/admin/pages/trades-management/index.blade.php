...
@component('components.breadcrumb')
    ...
    @slot('title')Trades Management @endslot
@endcomponent
<div class="row project-wrapper">
    <div class="col-xxl-8">
        <div class="card" id="contactList">
                           ...
                           <tr class="trade-row" data-status="{{ $trade->status }}">
                                ...
                                <td class="name">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 ms-2 name">{{ $trade->name }}</div>
                                    </div>
                                </td>
                                <td class="">{{ $trade->numbers }}</td>
                                <td class="">{{ $trade->item_code }}</td>
                                <td class="">{{ $trade->booking_price }}</td>
                                <td class="">{{ $trade->address }}</td>
                                <td class="">{{ $trade->special_note }}</td>
                                <td>
            ...
            <div class="modal fade" id="showModal{{$trade->id}}" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-0">
                           ...
                           <form action="{{ route('admin.trades-management.update', $trade->id)}}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-12">
                                            <div>
                                                ...
                                                <input type="text" id="customername-field" class="form-control" placeholder="Enter name" value="{{ $trade->name }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div>
                                                <label for="designation-field" class="form-label">Number</label>
                                                <input type="text" id="designation-field" class="form-control" placeholder="Enter Designation" value="{{ $trade->numbers }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div>
                                                <label for="designation-field" class="form-label">Item Code</label>
                                                <input type="text" id="company_name-field" class="form-control" placeholder="Enter Trade ID" value="{{ $trade->item_code }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div>
                                                <label for="email_id-field" class="form-label">Booking Price</label>
                                                <input type="text" id="email_id-field" class="form-control" placeholder="Enter Trades" value="{{ $trade->booking_price }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div>
                                                <label for="wallet_balance-field" class="form-label">Address</label>
                                                <input type="text" id="phone-field" class="form-control" placeholder="Enter Wallet Balance" value="{{ $trade->address }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div>
                                                <label for="create_date-field" class="form-label">Special Note</label>
                                                <input type="text" id="lead_score-field" class="form-control" placeholder="Enter Create Date" value="{{ $trade->special_note  }}">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-lg-12">
                                        ...
                                        <select id="status-field" name="status" class="form-select">
                                            ...
                                            <option value="booked" {{ $trade->status === 'booked' ? 'selected' : '' }}>Booked</option>
                                            <option value="delivered" {{ $trade->status === 'delivered' ? 'selected' : '' }}>Delivered</option>
                                            <option value="un-delivered" {{ $trade->status === 'un-delivered' ? 'selected' : '' }}>UnDelivered</option>
                                        </select>
                                    </div>
                                </div>
