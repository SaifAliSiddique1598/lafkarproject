...
<?php $__env->startSection('content'); ?>
    ...
    <div class="">
        <a href="<?php echo e(route('frontend.page', 'profile-edit')); ?>">
        ...
        <div class="rounded-lg py-4 px-6 mb-6 orangeGred">
            <div class="flex flex-col justify-between h-[180px]">
                ...
                <div class="border-t border-white">
                    <h4 class="text-lg font-semibold text-white pt-[8px]"><?php echo e($user->name); ?></h4>
                </div>
            </div>
        </div>
        <div class="">
            <div class="flex items-center mb-4">
                ...
                <div class="border border-primary py-2 curveClip w-[95%] ms-[-14px] mt-[4px] rounded-md">
                    <h2><span class="font-bold ps-6 text-">Designation:</span> <?php echo e($user->designation); ?></h2>
                </div>
            </div>
            <div class="flex items-center mb-4">
                <div class="w-[20px] h-[60px] bg-primary fancyBorder rounded-md"></div>
                <div class="border border-primary py-2 curveClip w-[95%] ms-[-14px] mt-[4px] rounded-md">
                    <h2><span class="font-bold ps-6 text-">Email:</span> <?php echo e($user->email); ?></h2>
                </div>
            </div>
            <div class="flex items-center mb-4">
                <div class="w-[20px] h-[60px] bg-primary fancyBorder rounded-md"></div>
                <div class="border border-primary py-2 curveClip w-[95%] ms-[-14px] mt-[4px] rounded-md">
                    <h2><span class="font-bold ps-6 text-">Trader Id:</span> <?php echo e($user->trade_id); ?></h2>
                </div>
            </div>
            <div class="flex items-center mb-4">
                <div class="w-[20px] h-[60px] bg-primary fancyBorder rounded-md"></div>
                <div class="border border-primary py-2 curveClip w-[95%] ms-[-14px] mt-[4px] rounded-md">
                    <h2><span class="font-bold ps-6 text-">Account Title:</span><?php echo e($user->account_title); ?></h2>
                </div>
            </div>
            <div class="flex items-center mb-4">
                <div class="w-[20px] h-[60px] bg-primary fancyBorder rounded-md"></div>
                <div class="border border-primary py-2 curveClip w-[95%] ms-[-14px] mt-[4px] rounded-md">
                    <h2><span class="font-bold ps-6 text-">Account Type:</span> <?php echo e($user->account_type); ?></h2>
                </div>
            </div>
            <div class="flex items-center mb-4">
                <div class="w-[20px] h-[60px] bg-primary fancyBorder rounded-md"></div>
                <div class="border border-primary py-2 curveClip w-[95%] ms-[-14px] mt-[4px] rounded-md">
                    <h2><span class="font-bold ps-6 text-">Acc #:</span><?php echo e($user->account_number); ?></h2>
                </div>
            </div>
            <div class="flex items-center mb-4">
                <div class="w-[20px] h-[60px] bg-primary fancyBorder rounded-md"></div>
                <div class="border border-primary py-2 curveClip w-[95%] ms-[-14px] mt-[4px] rounded-md">
                    <h2><span class="font-bold ps-6 text-">Contact:</span><?php echo e($user->contact); ?></h2>
                </div>
            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web dev\htdocs\lafkar-main\resources\views/frontend/profile.blade.php ENDPATH**/ ?>