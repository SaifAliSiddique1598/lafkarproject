            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.page', 'portfolio-management')); ?>" class="nav-link menu-link">
                        <i class="ri-dashboard-2-line"></i> <span><?php echo app('translator')->get('Portfolio Management'); ?></span>
                    </a>
                </li>
            </ul>
        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/MDUZAIR/00 Clients/Reseller /default/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>