...
<?php $__env->startSection('content'); ?>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="w-full h-[260px]">
                        <img src="<?php echo e(url('/')); ?>/frontend_assets/images/banner-1.jpg" class="w-full h-full object-cover rounded-lg" alt="Banner">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="w-full h-[260px]">
                        <img src="<?php echo e(url('/')); ?>/frontend_assets/images/banner-2.jpg" class="w-full h-full object-cover rounded-lg" alt="Banner">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="w-full h-[260px]">
    ...
    <section class="px-3 mt-6">
        ...
        <div class="grid grid-cols-12 mb-4  bg-bgGray p-2 rounded-lg">
            <div class="col-span-4">
                <div class="w-full h-[150px]">
                    <img src="<?php echo e(url('/')); ?>/frontend_assets/images/product-1.jpg" class="w-full h-full object-cover rounded-lg" alt="Banner">
                </div>
            </div>
        ...
        <div class="grid grid-cols-12 mb-4 bg-bgGray p-2 rounded-lg">
            <div class="col-span-4">
                <div class="w-full h-[150px]">
                    <img src="<?php echo e(url('/')); ?>/frontend_assets/images/product-3.jpg" class="w-full h-full object-cover rounded-lg" alt="Banner">
                </div>
            </div>
            <div class="col-span-8">
                <div class="flex flex-col justify-between h-full ps-4">
        ...
        <div class="grid grid-cols-12 mb-4 bg-bgGray p-2 rounded-lg">
            <div class="col-span-4">
                <div class="w-full h-[150px]">
                    <img src="<?php echo e(url('/')); ?>/frontend_assets/images/product-2.jpg" class="w-full h-full object-cover rounded-lg" alt="Banner">
                </div>
            </div>
            <div class="col-span-8">
                <div class="flex flex-col justify-between h-full ps-4">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/MDUZAIR/00 Clients/Reseller /lafkar/resources/views/frontend/index.blade.php ENDPATH**/ ?>