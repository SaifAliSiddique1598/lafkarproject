    ...
    <div class="menuBx bg-white fixed top-[65px] left-0 w-full h-full p-4 z-10" id="menuBx">
        <ul class="pt-4">
            <li class="border-b border-grayText">
                <a href="<?php echo e(route('frontend.page', '/')); ?>" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Home</div></a>
            </li>
            <li class="border-b border-grayText">
                <a href="<?php echo e(route('frontend.page', 'company-profile')); ?>" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Company Profile</div></a>
            </li>
            <li class="border-b border-grayText">
                <a href="<?php echo e(route('frontend.page', 'lafkar-welfare')); ?>" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Lafkar Welfare</div></a>
            </li>
            <li class="border-b border-grayText">
                <a href="<?php echo e(route('frontend.page', 'job-onboard')); ?>" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Jobs Onboard</div></a>
            </li>
            <li class="border-b border-grayText">
                <a href="<?php echo e(route('frontend.page', 'support')); ?>" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Support</div></a>
            </li>
            <li class="border-b border-grayText">
                <a href="<?php echo e(route('frontend.page', 'term-condition')); ?>" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Terms and Conditions</div></a>
            </li>
            <li class="border-b border-grayText">
                <a href="<?php echo e(route('frontend.page', 'privacy-policy')); ?>" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Privacy Policy</div></a>
            </li>
            <?php if(auth()->guard()->check()): ?>
                <li class="border-b border-grayText">
                    <a href="<?php echo e(route('frontend.page', 'change_password')); ?>" class="">
            ...
            <li class="border-b border-grayText">
                <a href="<?php echo e(route('frontend.page', 'sign_in')); ?>" class="">
             ...
             <?php if(auth()->guard()->guest()): ?> 
            <li class="border-b border-grayText">
                <a href="<?php echo e(route('frontend.page', 'sign_up')); ?>" class="">
...
<?php /**PATH D:\web dev\htdocs\lafkar-main\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>