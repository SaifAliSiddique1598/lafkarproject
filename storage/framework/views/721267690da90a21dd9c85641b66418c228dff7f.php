                ...
                <div class="d-flex align-items-center flex-wrap gap-2">
                    <div class="flex-grow-1">
                        <button class="btn btn-info add-btn" data-bs-toggle="modal"
                                ...
                                class="ri-add-fill me-1 align-bottom"></i> Add Profile</button>
                    </div>
                    ...
                    <div class="table-responsive table-card mb-3">
                        <table class="table align-middle table-nowrap mb-0" id="customerTable">
                            ...
                            <tr>
                                ...
                                <td class="">Lead Designer / Developer</td>
                                <td class="">20</td>
                                <td class="">405</td>
                                <td class="">$2,00,000</td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/MDUZAIR/00 Clients/Reseller /lafkar/resources/views/admin/pages/profile-management.blade.php ENDPATH**/ ?>