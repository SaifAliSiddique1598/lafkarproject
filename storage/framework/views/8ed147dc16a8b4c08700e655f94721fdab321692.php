        ...
        <div class="rounded-lg py-4 px-6 mb-6 orangeGred">
            <div class="flex flex-col justify-between h-[180px]">
                ...
                <div class="border-t border-white">
                    <h4 class="text-lg font-semibold text-white pt-[8px]">Joy Root</h4>
                </div>
            </div>
        </div>
        <div class="">
            <div class="flex items-center mb-4">
                ...
                <div class="border border-primary py-2 curveClip w-[95%] ms-[-14px] mt-[4px] rounded-md">
                    <h2><span class="font-bold ps-6 text-">Designation:</span> Trader</h2>
                </div>
            </div>
            <div class="flex items-center mb-4">
                <div class="w-[20px] h-[60px] bg-primary fancyBorder rounded-md"></div>
                <div class="border border-primary py-2 curveClip w-[95%] ms-[-14px] mt-[4px] rounded-md">
                    <h2><span class="font-bold ps-6 text-">Email:</span> joyroot@gmail.com</h2>
                </div>
            </div>
            <div class="flex items-center mb-4">
                <div class="w-[20px] h-[60px] bg-primary fancyBorder rounded-md"></div>
                <div class="border border-primary py-2 curveClip w-[95%] ms-[-14px] mt-[4px] rounded-md">
                    <h2><span class="font-bold ps-6 text-">Trader Id:</span> 000000000000000</h2>
                </div>
            </div>
            <div class="flex items-center mb-4">
                <div class="w-[20px] h-[60px] bg-primary fancyBorder rounded-md"></div>
                <div class="border border-primary py-2 curveClip w-[95%] ms-[-14px] mt-[4px] rounded-md">
                    <h2><span class="font-bold ps-6 text-">Account Title:</span> Joy Root</h2>
                </div>
            </div>
            <div class="flex items-center mb-4">
                <div class="w-[20px] h-[60px] bg-primary fancyBorder rounded-md"></div>
                <div class="border border-primary py-2 curveClip w-[95%] ms-[-14px] mt-[4px] rounded-md">
                    <h2><span class="font-bold ps-6 text-">Account Type:</span> Paypal</h2>
                </div>
            </div>
            <div class="flex items-center mb-4">
                <div class="w-[20px] h-[60px] bg-primary fancyBorder rounded-md"></div>
                <div class="border border-primary py-2 curveClip w-[95%] ms-[-14px] mt-[4px] rounded-md">
                    <h2><span class="font-bold ps-6 text-">Acc #:</span> 000000000000000</h2>
                </div>
            </div>
            <div class="flex items-center mb-4">
                <div class="w-[20px] h-[60px] bg-primary fancyBorder rounded-md"></div>
                <div class="border border-primary py-2 curveClip w-[95%] ms-[-14px] mt-[4px] rounded-md">
                    <h2><span class="font-bold ps-6 text-">Contact:</span> 0000 0000000</h2>
                </div>
            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\app_view_dash\resources\views/frontend/profile.blade.php ENDPATH**/ ?>