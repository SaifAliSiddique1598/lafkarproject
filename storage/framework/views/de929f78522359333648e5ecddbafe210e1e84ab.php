<header>
    ...
    <div class="menuBx bg-white fixed top-[65px] left-0 w-full h-full p-4 z-10" id="menuBx">
        <ul class="pt-4">
            ...
            <li class="border-b border-grayText">
                <a href="#" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Company Profile</div></a>
            </li>
            <li class="border-b border-grayText">
                <a href="#" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Lafkar Welfare</div></a>
            </li>
            <li class="border-b border-grayText">
                <a href="#" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Jobs Onboard</div></a>
            </li>
            <li class="border-b border-grayText">
                <a href="#" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Support</div></a>
            </li>
            <li class="border-b border-grayText">
                <a href="#" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Terms and Conditions</div></a>
            </li>
            <li class="border-b border-grayText">
                <a href="#" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Privacy Policy</div></a>
            </li>
            <li class="border-b border-grayText">
                <a href="#" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Change Password</div></a>
            </li>
            <li class="border-b border-grayText">
                <a href="<?php echo e(route('frontend.page', 'sign_up')); ?>" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Sign up </div></a>
            </li>
            <li class="border-b border-grayText" id="closeMenu">
                <a href="" class=""><div class="text-lg uppercase font-semibold hover:text-primary py-[12px]">Exit</div></a>
            </li>
        </ul>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/MDUZAIR/00 Clients/Reseller /lafkar/resources/views/frontend/layouts/header.blade.php ENDPATH**/ ?>